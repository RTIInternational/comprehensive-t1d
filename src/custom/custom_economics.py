class CustomEconomics:
    ...
    def get_interventions_costs(self, scenario):
        ...
        if 'lifestyle_control_intervention' in interventions.keys():
            ...
            if lifestyle_type == 'basic':
                ...
                lifestyle_advanced_medicare_costs = \
                interventions['lifestyle_control_intervention']['lifestyle_control_costs_medicare'][0]
                lifestyle_dict = {
                    'type': lifestyle_type,
                    ...
                    'advanced year 1 medicare': lifestyle_advanced_medicare_costs['year_1_cost'],
                    'advanced year 2 medicare': lifestyle_advanced_medicare_costs['year_2_cost'],
                    'advanced year 3 medicare': lifestyle_advanced_medicare_costs['year_3_cost'],
                    'advanced year subsequent medicare': lifestyle_advanced_medicare_costs['subsequent_year_cost']
                }
            all_cost_dict['lifestyle'] = lifestyle_dict
        if 'surgery_control_intervention' in interventions.keys():
            surgery_advanced_costs = interventions['surgery_control_intervention']['surgery_control_costs'][0]
            surgery_advanced_medicare_costs = \
                interventions['surgery_control_intervention']['surgery_control_costs_medicare'][0]
            surgery_dict = {
                'surgery type': surgery_advanced_costs['surgery_type'],
                'bypass surgery': surgery_advanced_costs['cost_bypass'],
                'sleeve surgery': surgery_advanced_costs['cost_sleeve'],
                'cost complications': surgery_advanced_costs['cost_complications'],
                'bypass surgery medicare': surgery_advanced_medicare_costs['cost_bypass'],
                'sleeve surgery medicare': surgery_advanced_medicare_costs['cost_sleeve'],
                'cost complications medicare': surgery_advanced_medicare_costs['cost_complications'],
                'cost_reduction_improvement': surgery_advanced_costs['cost_reduction_improvement'],
                'cost_drop_bp_drug': surgery_advanced_costs['cost_dropped_bp_med'],
                'cost_drop_statin': surgery_advanced_costs['cost_dropped_statin'],
                'cost_drop_other': surgery_advanced_costs['cost_other']
            }
            if 'cost_reduction_remission' in surgery_advanced_costs.keys():
                surgery_dict['cost_reduction_remission'] = surgery_advanced_costs['cost_reduction_remission']
            all_cost_dict['surgery'] = surgery_dict
    ...
    def calculate_t2d_values(self):
        ...
        if 'qaly_increase_per_bmi' in self.scenario['disutilities'].keys():
            self._value_dict['disutilities']['qaly_increase_per_bmi'] = self.scenario['disutilities']['qaly_increase_per_bmi']
            self._value_dict['disutilities']['qaly_increase_other'] = self.scenario['disutilities']['qaly_increase_other']
    ...
    def calculate_prediabetes_values(self):
        ...
        if 'qaly_increase_per_bmi' in self.scenario['disutilities'].keys():
            self._value_dict['disutilities']['qaly_increase_per_bmi'] = self.scenario['disutilities'][
                'qaly_increase_per_bmi']
            self._value_dict['disutilities']['qaly_increase_other'] = self.scenario['disutilities']['qaly_increase_other']
