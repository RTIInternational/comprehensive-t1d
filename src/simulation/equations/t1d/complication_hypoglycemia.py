...
FACTORS = {
    "intercept": [-0.51310, 0.32238],
    "shape": [0.56472, 0.01648],
    "age_entry": [-0.00775, 0.00452],
    "diabetes_duration_entry": [0.02043, 0.00493],
    "female": [0.02118, 0.05501],
    "lag_tv_amputation": [1.21290, 0.36468],
    "mean_bmi": [-0.01465, 0.00896],
    "mean_hba1c": [-0.13635, 0.01926],
    "mean_insulin_dose": [0.90625, 0.12401]
}
MODIFIED_FACTORS = deepcopy(FACTORS)

def calculate(individual, step, custom_values, intervention, is_intervention, rng):
    """
    Calculate probability of hypoglycemia
    """

    # if has_event(individual, 'hypoglycemia'):
    #     return 0
    ...
    complication_multiplier = custom_values['complication_multipliers']['hypoglycemia multiplier']
